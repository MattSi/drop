...
import com.badlogic.drop.ch08.BaseScreen;
...
public abstract class BaseGame extends Game
{
    ...
    {        
        ...
        FreeTypeFontGenerator fontGenerator = 
            new FreeTypeFontGenerator(Gdx.files.internal("jigsaw/OpenSans.ttf"));
        ...
        Texture   buttonTex   = new Texture( Gdx.files.internal("jigsaw/button.png") );
