...
public class LevelScreen extends BaseScreen
{
    ...
    {        
        ...
        background.loadTexture("jigsaw/background.jpg");
        
        int numberRows = 3;
        int numberCols = 3;
        
        Texture texture = new Texture(Gdx.files.internal("jigsaw/sun.jpg"), true);
    ...
    public void update(float dt)
    {
        ...
        boolean solved = true;
        for (BaseActor actor : BaseActor.getList(mainStage, "com.badlogic.drop.ch09.jigsaw.PuzzlePiece"))
        {
