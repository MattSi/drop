...
public class RhythmScreen extends BaseScreen{
    ...
    public void initialize() {
        ...
        background.loadTexture( "rhythmtapper/space.png" );
        ...
        startButton.addListener((Event e) ->{
            ...
            FileHandle dataFileHandle = Gdx.files.internal("rhythmtapper/FunkyJunky.key");
            songData = new SongData();
            songData.readFromFile(dataFileHandle);
            songData.resetIndex();

            FileHandle songFileHandle = Gdx.files.internal("rhythmtapper/" + songData.getSongName());
