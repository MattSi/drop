...
public class LevelScreen extends BaseScreen
{
    ...
    public void initialize()
    {
        ...
        background.loadTexture("maze/white.png");
        ...
        for (BaseActor room : BaseActor.getList(mainStage, "com.badlogic.drop.ch14.Room"))
        {
    ...
    {
        for (BaseActor wall : BaseActor.getList(mainStage, "com.badlogic.drop.ch14.Wall"))
        {
        ...
        for (BaseActor coin : BaseActor.getList(mainStage, "com.badlogic.drop.ch14.Coin"))
        {
        ...
        int coins = BaseActor.count(mainStage, "com.badlogic.drop.ch14.Coin");
