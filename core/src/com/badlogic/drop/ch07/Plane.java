...
public class Plane extends BaseActor{
    public Plane(float x, float y, Stage s) {
        super(x, y, s);
        String[] filenames = {
                "planedodger/planeGreen0.png",
                "planedodger/planeGreen1.png",
                "planedodger/planeGreen2.png",
                "planedodger/planeGreen1.png"
        };
    ...
    public void act(float dt) {
        ...
        for(BaseActor g: BaseActor.getList(this.getStage(),"com.badlogic.drop.ch07.Ground")){
            if(this.overlaps(g)){
                setSpeed(0);
                preventOverlap(g);
            }
