...
public class StoryScreen extends BaseScreen {
    ...
    public void initialize() {
        ...
        background.loadTexture("starfish/oceanside.png");
        ...
        turtle.loadTexture("starfish/turtle-big.png");
