...
public class LevelScreen extends BaseScreen {
    ...
    public void update(float dt) {
        ...
        starfishLabel.setText("Starfish Left:" + BaseActor.count(mainStage, "com.badlogic.drop.ch15.starfish.Starfish"));

        for(BaseActor signActor : BaseActor.getList(mainStage, "com.badlogic.drop.ch15.starfish.Sign")){
